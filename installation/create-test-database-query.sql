-- Test Database Schema (without database creation)
-- This file is used for PHPUnit tests
-- Database 'leaves_management_test' should be created before running this
CREATE DATABASE IF NOT EXISTS leaves_management_test;
USE leaves_management_test;
